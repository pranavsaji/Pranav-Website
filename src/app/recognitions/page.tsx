  ...
  itemListElement: [
    {
      ...
      item: {
        ...
        subjectOf: { "@type": "CreativeWork", name: "Meet the Judges", url: "https://aihackathon.usaii.org/content/docs/meet-the-judges.pdf" },
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                    ...
                    {"secondaryLink" in rec && rec.secondaryLink && (
                      <a
                        href={rec.secondaryLink}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 text-xs font-medium transition-opacity opacity-70 hover:opacity-100"
                        style={{ color: s.text }}
                      >
                        {rec.secondaryLinkLabel}
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                        </svg>
                      </a>
